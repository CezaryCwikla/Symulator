        ...
        if sensor.E > 0:
            if sensor.type == 'N':
                if curr_fun in sensor.Fun:
                    ...
                    axis.plot(xl, yl)
                if w_flag:
                    axis.scatter([sensor.xd], [sensor.yd], c='k', edgecolors='k', s=rozmiar_wezla, label='Node')
                    w_flag = False
                else:
                    axis.scatter([sensor.xd], [sensor.yd], c='k', edgecolors='k', s=rozmiar_wezla)
                if 'f4' in sensor.Fun and f4_flag:
                    axis.scatter(sensor.xd-oddalenie_od_srodka_hor, [sensor.yd], c='b', s=80, edgecolors='k', label='Function F4', marker='>')
                    f4_flag = False
                ...
                if 'f3' in sensor.Fun and f3_flag:
                    axis.scatter(sensor.xd+oddalenie_od_srodka_hor, [sensor.yd], c='g', s=80, edgecolors='k', label='Function F3', marker='<')
                ...
                if 'f2' in sensor.Fun and f2_flag:
                    axis.scatter([sensor.xd], sensor.yd+oddalenie_od_srodka, c='orange', s=80, edgecolors='k', label='Function F2', marker='v')
                ...
                if 'f1' in sensor.Fun and f1_flag:
                    axis.scatter([sensor.xd], sensor.yd-oddalenie_od_srodka, c='m', s=80, edgecolors='k', label='Function F1', marker='^')
